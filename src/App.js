...
export default class App extends Component {
    ...
    submit(e) {
        ...
        //axios.post("http://localhost:5000/abc", { headers: {'CrossDomain':true}}, fo).then((res) => { toast.success("Added")});
    }
    handleChange(event) {
                ...
                <div className="main">
                    ...
                    <div className="companybox">
                        ...
                        <form onSubmit={this.submit}>
                            <p style={{ color: 'white', fontFamily: 'Georgia' }}>ENTER THE STATEMENTS HERE :</p>                            <br></br>
                            <textarea
                                name="Title"
                                type="textarea"
                                borderRadius="5px"
                                name="address"
                                placeholder="ENTER SPARK SQL STATEMENTS"
                                id="oo"
                                required
